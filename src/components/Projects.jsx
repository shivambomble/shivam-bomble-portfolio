  ...
  return (
    <motion.a
      ...
      whileHover={{
        ...
        boxShadow: "0 25px 70px rgba(146, 64, 14, 0.15), 0 0 40px rgba(217, 119, 6, 0.05)",
      }}
      whileTap={{ scale: 0.98 }}
...
export default function Projects() {
  ...
  return (
    <AnimatedSection id="projects" className="section">
      <div className="orb orb-3" style={{ width: "300px", height: "300px", background: "#ea580c", top: "20%", left: "10%" }} />
      ...
      <style>{`
        ...
        .project-card::after {
          ...
          inset: -1px;
          border-radius: 21px;
          background: linear-gradient(135deg, transparent 20%, rgba(217, 119, 6, 0.08), rgba(234, 88, 12, 0.04), transparent 80%);
          z-index: -1;
          opacity: 0;
